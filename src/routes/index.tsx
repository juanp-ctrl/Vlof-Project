  ...
  return (
    <>
      ...
      <div class="container_intro">
        ...
        <div class="intro">
          <p>Bienvenido a VLOF, el lugar de las ideas, de los colores, en donde las cosas simplemente existen, quizás no encuentres relación entre lo que existe en este sitio, pero esa es la idea.</p>
        </div>
